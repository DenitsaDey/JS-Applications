...
import {renderCreateGame} from './views/createGameView.js'
import {renderGameDetails } from './views/detailsGameView.js'
import {renderEditGame } from './views/editGameView.js'
...
page('/create', renderCreateGame);
page('/details/:gameId', renderGameDetails);
page('/edit/:gameId', renderEditGame);
